      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid w-full grid-cols-1 items-center gap-10 sm:gap-12 lg:gap-16 lg:grid-cols-2">
          <FadeInSection className="order-1 space-y-6 text-left sm:space-y-8 lg:order-2 lg:ml-auto lg:text-right">
            ...
            <br />
            <div className="mt-28 flex flex-wrap items-center gap-14 sm:gap-16 lg:mt-32 lg:justify-end lg:gap-20">
            {CERTIFICATES.map((cert, index) => (
              <img
                key={cert.alt}
                src={cert.src}
                alt={cert.alt}
                className={`w-auto object-contain opacity-80 grayscale transition-all duration-300 hover:scale-105 hover:opacity-100 hover:grayscale-0 
                  ${index === 1 || index === 2 
