...
const listClass = 'mt-2 list-inside list-disc space-y-1 font-sans text-[15px] font-light leading-relaxed text-[#4A3F36]'
const paraClass = 'mt-2 font-sans text-[15px] font-light leading-relaxed text-[#4A3F36]'
    ...
    <>
      ...
      <div className="mt-8 space-y-8">
        ...
        <section>
          ...
          <div className={`mt-2 ${paraClass}`}>
            <p className="font-sans font-medium text-[#4A3F36]">ARSK Exports</p>
